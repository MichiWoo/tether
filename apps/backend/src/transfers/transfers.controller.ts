...
export class TransfersController {
  ...
  @ApiResponse({ status: 201, description: 'Share creado', type: ShareResponse })
  ...
  @ApiResponse({ status: 200, description: 'Lista de shares', type: [ShareResponse] })
  ...
  @ApiResponse({ status: 200, description: 'Detalle con downloadUrl', type: ShareDetailResponse })
  ...
  @ApiResponse({ status: 201, description: 'Share aceptado', type: ShareResponse })
  ...
  @ApiResponse({ status: 201, description: 'Share marcado como descargado', type: ShareResponse })
  @ApiResponse({ status: 400, description: 'Share expirado' })
  @ApiResponse({ status: 404, description: 'Share no encontrado' })
  ...
  @ApiResponse({ status: 201, description: 'Share cancelado', type: ShareResponse })
  @ApiResponse({ status: 404, description: 'Share no encontrado' })
